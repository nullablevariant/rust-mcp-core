...
## Covers
- Inline + plugin resources and resource templates.

## Run
```bash
cargo run --example resources-inline-plugin
...
curl -sS http://127.0.0.1:31943/mcp \
  ...
  -H "accept: application/json, text/event-stream" \
  -H "MCP-Session-Id: ${SESSION_ID}" \
  -d "{\"jsonrpc\":\"2.0\",\"id\":3,\"method\":\"resources/read\",\"params\":{\"uri\":\"resource://docs/terms\"}}"
```
