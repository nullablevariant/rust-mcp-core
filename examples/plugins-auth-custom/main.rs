...
use plugin::{CustomValidatorPlugin, ProviderValidatorPlugin};
...
async fn main() -> Result<(), McpError> {
    ...
    let plugins = PluginRegistry::new()
        .register_auth(CustomValidatorPlugin)?
        .register_auth(ProviderValidatorPlugin)?;
