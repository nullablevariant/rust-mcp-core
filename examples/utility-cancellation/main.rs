...
use plugin::{CancellableSleepPlugin, NonCancellableSleepPlugin};
...
async fn main() -> Result<(), McpError> {
    ...
    let plugins = PluginRegistry::new()
        .register_tool(CancellableSleepPlugin)?
        .register_tool(NonCancellableSleepPlugin)?;
