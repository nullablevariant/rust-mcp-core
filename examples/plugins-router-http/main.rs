...
use plugin::{HealthzRouterPlugin, McpGuardRouterPlugin};
...
async fn main() -> Result<(), McpError> {
    ...
    let plugins = PluginRegistry::new()
        .register_http_router(HealthzRouterPlugin)?
        .register_http_router(McpGuardRouterPlugin)?;
