...
## Covers
- Client roots, sampling, and elicitation request helpers from plugin code.

## Run
```bash
cargo run --example plugins-tool-client-features-advanced
```
...
Note: full success for roots/sampling/elicitation requires a full MCP client with negotiated capabilities.
